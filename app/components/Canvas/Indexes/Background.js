...
export default class extends Mesh {
  ...
  set(index) {
    ...
    if (this.covers) {
      this.material.uniforms.transition.value = this.covers[index]
      this.material.uniforms.image.value = this.covers[index]
    }
  }
   ...
   */
  change(index) {
    if (this.isAnimating || this.index === index) {
      return
    }
    ...
    this.timeline.call(() => {
      this.material.uniforms.isAnimating.value = 1
      this.material.uniforms.transition.value = this.covers[index]
    })
    ...
    this.timeline.call(() => {
      this.material.uniforms.isAnimating.value = 0
      this.material.uniforms.image.value = this.covers[index]
